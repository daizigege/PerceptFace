...
For data preprocessing, you need to crop it to 224 based on data_process_to_224, download insightface see https://github.com/neuralchen/SimSwap/blob/main/docs/guidance/preparation.md
